...
public enum DiscoveryMessageType {
    ...
    COMMIT_ACK,
    /**
     * The evicted node removes the direct target node from its neighbor list. This
     * one is sent by the direct target to the victim
     */
    COMMIT_DELETE,
    /**
     * Acknowledges COMMIT_DELETE (accepted or rejected). This one is sent by the
     * victim back to the direct target in response to COMMIT_DELETE
     */
    COMMIT_DELETE_ACK,
    /**
