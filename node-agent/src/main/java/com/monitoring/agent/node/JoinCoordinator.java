...
// CompletableFuture.allOf(joinRequests.toArray(new CompletableFuture[0]));
...
// Optional<JoinConfirmResult> result = nodeClient.confirmJoin(candidate,
// localAddress).join();
...
// Optional<JoinConfirmResult> result = nodeClient.confirmJoin(redistributed,
// localAddress).join();
...
// private void addCandidate(Map<String, NodeAddress> candidates, NodeAddress
// candidate) {
// if (candidate == null) {
// return;
// }
