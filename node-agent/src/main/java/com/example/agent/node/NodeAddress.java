...
record NodeAddress(String nodeId, String host, int port) {
    ...
    // Parses the compact address format used inside DiscoveryMessage neighbor lists.
    ...
    static NodeAddress from(String value) {
        ...
        return new NodeAddress(nodeId, hostAndPort[0], Integer.parseInt(hostAndPort[1]));
    }
